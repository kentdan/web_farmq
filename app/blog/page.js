    ...
    <>
      <section className="text-center max-w-xl mx-auto mt-12 mb-24 md:mb-32">
        ...
        <p className="text-lg opacity-80 leading-relaxed">
          This blog is where I share the small things I learn. I write about everything from startup, AI, South East Asia, my thoughts, my hobby and more. I hope you find something useful here.
        </p>
      </section>
